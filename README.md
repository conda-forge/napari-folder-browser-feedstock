...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/napari-folder-browser-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15271&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/napari-folder-browser-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `napari-folder-browser` can be installed with:

```
conda install napari-folder-browser
```

It is possible to list all of the versions of `napari-folder-browser` available on your platform with:
